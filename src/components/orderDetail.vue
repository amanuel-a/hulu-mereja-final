<template>
    <v-container>
        <br><br><br>
        <v-row no-gutters>
            <v-col cols="12" sm="7" class="pa-4 mx-auto" style="height: 100%">
            ...
            <v-col cols="12" sm="5" class="pa-5 mx-auto">
              <v-card class="pa-2 text-center" min-height="415">
                <h2 class="btncolor--text text-center display-1">{{detail.fullName}}</h2>
                   <v-card-text >
                  ...
                  <v-card-subtitle >
                    <p class="btncolor--text px-3 pt-3">Accept it according to the price he/she paid.</p>
                  </v-card-subtitle>
                  <v-card-text class="grey--text">
                    <div class="text-xs-center btncolor mx-3">

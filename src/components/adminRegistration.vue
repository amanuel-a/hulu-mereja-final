               ...
               <v-window>
                  <v-window-item>
                    ...
                    <v-row align="center" justify="center">
                      ...
                      <v-col cols="12" md="6">
                        <v-card-text>
                            <h1 class="text-center display-2  secondary--text">Signup</h1>
                              ...
                              <br>
                               <div class="text-center mt-1">
                                  <v-btn rounded outlined="" block @click="adminRegistration" class="secondary white--text pl-15 pr-15">signup</v-btn>
                                </div>
                          </v-card-text>
                      </v-col>
                    </v-row>
